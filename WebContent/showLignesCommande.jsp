...
<header  >
  ...
  <div class="ani">
  <h1>Commands Lignes <i class="fa-solid fa-bell fa-shake"></i><div class="spinner-border text-info" role="status">
  <span class="visually-hidden">Loading...</span>
</div></h1>
 </div>
<div class="fa-1x">
 		<c:if test="${ sessionScope.user.getTypeUtil() == 1 }">
   <a href="createProduit.jsp" class="main-btn"><i class="fa-solid fa-user-plus"></i>Create new command ligne </a>
	</c:if>
	   <div class="cont">
				...
				<tbody>
					<c:forEach items="${ listLigCmd }" var="lcmd">
						<tr>
							...
							<c:if test="${ sessionScope.user.getTypeUtil() != 1 }">
								<td><a href="DeleteServlet?id=${ lcmd.getIdLigneCmd() }">    <i class="fa-solid fa-trash"></i> 
								</a>
							<a href="ShowListServlet?act=44&id=${ lcmd.getIdLigneCmd() }"> 	<i class="fa-solid fa-user-pen"></i>
								</a></td>
							</c:if>
						</tr>
					</c:forEach>
