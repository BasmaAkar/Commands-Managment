...
<header  >
  ...
  <div class="ani">
  <h1>Commands<i class="fa-solid fa-bell fa-shake"></i><div class="spinner-border text-info" role="status">
 ...
 <div class="fa-1x">
   ...
   <a href="CreateServlet?act=1" class="main-btn"><i class="fa-solid fa-user-plus"></i>Add new  Command</a>
	     ...
	     <table class="table table-bordered  ">
                <thead >
                    <tr class="table-success">
						...
						<th scope="col"> Commands Ligns </th>
				...
				<tbody>
					<c:forEach items="${ listCmd }" var="cmd">
						<tr>
							...
							<td>${ cmd.getIdUtil() }</td>
								<td>
								<a href="ShowListServlet?act=4&id=${ cmd.getIdCmd() }">
										Show More  </a>
										</td>
						    		<td>
						    		<a href="DeleteServlet?id=${ cmd.getIdCmd() }">
